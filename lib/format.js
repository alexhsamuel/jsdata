...
const summarize     = require('./summarize.js').summarize
...
function elide(string, width, ellipsis='\u2026', position=1) {
...
function palide(string, width, ellipsis='\u2026', pad=' ', elidePosition=1, padPosition=1) {
  string = string || ''
  return (
...
function formatter(width, precision=null) {
