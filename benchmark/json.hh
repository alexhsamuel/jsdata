...
public:
  ...
  static Json string(std::string const& val) { return Json(val); }
  static Json boolean(bool const val)   { return Json(val); }
  static Json number(double const val)  { return Json(val); }
